...
def main() -> None:
    ...
    baseline, candidate = performance["conditions"]["baseline"], performance["conditions"]["teacache"]
    fidelity = {
    ...
    payload = {
        "schema": "teacache_vbench200_report_v3", "method": "TeaCache4Wan22",
        ...
        "baseline_reuse": config.get("baseline_reuse"),
        "paired_fidelity_teacache_against_baseline": fidelity,
        "vbench200_subset_scores": {"official_full_vbench_score": False, "baseline": reference_vbench, "teacache": candidate_vbench},
        "performance": {
    ...
    b, c, comparison = payload["performance"]["baseline"], payload["performance"]["teacache"], payload["performance"]["comparison"]
    ...
    output_md.write_text(
        "# TeaCache4Wan22 Vbench200 report\n\n"
