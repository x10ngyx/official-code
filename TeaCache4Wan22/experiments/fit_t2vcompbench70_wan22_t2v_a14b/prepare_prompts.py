...
def main() -> None:
    ...
    (args.output_dir / "README.md").write_text(
        "# TeaCache4Wan22 70-prompt calibration result\n\n"
        "This directory is generated by "
        "`experiments/fit_t2vcompbench70_wan22_t2v_a14b/prepare_prompts.py`.\n"
        "It contains the pinned prompt manifest, four resumable worker shards, "
        "per-prompt full-compute scalar traces, raw quartic fits, and logs. "
        "Large generated results remain outside the source repository.\n",
        encoding="utf-8",
    )
