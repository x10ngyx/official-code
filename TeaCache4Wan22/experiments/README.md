...
- `vbench200_t2v/`：正式 `.29/.45/.68` 三档 VBench200 管线；直接复用 SeaCache no-cache baseline，以四卡 persistent batch worker 两波错峰生成，三档生成完成后自动计算性能、PSNR/SSIM/LPIPS、16 维 VBench 和汇总报告。
