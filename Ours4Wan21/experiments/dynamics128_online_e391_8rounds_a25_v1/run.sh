...
run_dir="$exp_root/ours21_dynamics128_e391_online_offline800_8rounds_a25_v1"
...
case "${1:-run}" in
  prepare)
    exec "$WAN22_PYTHON" online.py prepare \
      --dataset "$exp_root/ours21_random3000_12groups_v1_sea7_dynamics_raw_sea128_cache" \
      --start-checkpoint /mnt/hdd/xiongyuxiang/tmp/models/ours21_random3000_12groups_v1_sea7_dynamics_raw_sea128/checkpoints/epoch_391.pt \
      ...
      --weights-dir /mnt/hdd/xiongyuxiang/tmp/models/ours21_dynamics128_e391_online_offline800_8rounds_a25_v1
    ;;
  run)
    "$WAN22_PYTHON" "$project_dir/experiments/dynamics128_online_e391_8rounds_a25_v1/reuse_offline_evaluation.py"
