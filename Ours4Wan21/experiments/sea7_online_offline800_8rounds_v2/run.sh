...
run_dir="$exp_root/ours21_sea7_e328_online_offline800_8rounds_v2"
...
case "${1:-run}" in
  prepare)
    exec "$WAN22_PYTHON" online.py prepare \
      ...
      --gpus 0,1,2,3 --rounds 8 --output-dir "$run_dir" \
      --weights-dir /mnt/hdd/xiongyuxiang/tmp/models/ours21_sea7_e328_online_offline800_8rounds_v2
    ;;
  run)
