...
```bash
conda run --no-capture-output -n wan2.2 python experiments/rl_validation_v1/validate.py --output-dir /mnt/hdd/xiongyuxiang/tmp/exp/UNIQUE_OURS21_CPU_VALIDATION
```
