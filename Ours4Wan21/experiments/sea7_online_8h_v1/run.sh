...
run_dir="$exp_root/ours21_sea7_e328_online_8h_v1"
setup_dir="$exp_root/ours21_sea7_e328_online_8h_v1_setup"
...
case "${1:-run}" in
  prepare)
    exec "$WAN22_PYTHON" online.py prepare \
      ...
      --train-prompts "$setup_dir/ours21_sea7_e328_online_8h_v1_pool/train_prompts.jsonl" \
      ...
      --gpus 0,1,2,3 --rounds 2 --output-dir "$run_dir" \
      --weights-dir /mnt/hdd/xiongyuxiang/tmp/models/ours21_sea7_e328_online_8h_v1
    ;;
  run)
