...
from run import PROJECT,ROOT,BASELINE,TRAINING,ANALYSIS,WEIGHTS,CACHE
...
OLD_NAME='ours21_random3000_12groups_v1_sea7_dynamics_raw_sea128'
...
def main():
    ...
    for metric,title in [('mean_Q','Mean Q'),('Q_IQR','Q interquartile range')]:
        ...
        ax.set(xlabel='Training epoch',ylabel=metric,title=title+' | Dynamics128, same validation states',xlim=(1,405))
    ...
    fig.suptitle('Dynamics128 | changed objectives: raw losses do not rank policy quality')
