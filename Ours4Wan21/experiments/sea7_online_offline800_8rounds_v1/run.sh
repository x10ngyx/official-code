...
run_dir="$exp_root/ours21_sea7_e328_online_offline800_8rounds_v1"
...
case "${1:-run}" in
  prepare)
    exec "$WAN22_PYTHON" online.py prepare \
      ...
      --weights-dir /mnt/hdd/xiongyuxiang/tmp/models/ours21_sea7_e328_online_offline800_8rounds_v1
    ;;
  run)
