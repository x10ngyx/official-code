...
from .contracts import OFFICIAL, PROJECT, PROTOCOL, dump, sha256
from .online_common import prepare_directory, read, seal, verified, require_environment
    ...
    for job in jobs:
        ...
        if job['kind']!='baseline':
            ...
            if ckpt['sha256'] not in policies:
                policies[ckpt['sha256']]=Policy(ckpt['path'],device='cuda:0',state_mode=manifest['mode'])
