"""Read-only final-result audit of SeaCache random50 nominal2.4x."""
import json
import math
from pathlib import Path
import statistics
import sys
sys.path.insert(0,str(Path(__file__).resolve().parents[1]/'vbench50_speed24_v1'))
...
def audit():
    ...
    result=results[0]; assert float(result['target'])==2.4
